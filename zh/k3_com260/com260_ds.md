...
本文档主要介绍K3-CoM260的基本规格和硬件特性，旨在帮助开发人员快速熟悉核心板规格，更准确高效地完成K3-CoM260应用及产品开发。
...
下图展示了K3-CoM260模块的实物图。

![](./static/com260_real01.png)

### 3.2 引脚封装

本节详细介绍了K3-CoM260的引脚封装信息。
