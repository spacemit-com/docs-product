...
当 USB 3.0 设备与 USB 2.4GHz 无线键鼠接收器接入在靠近的 USB3.0 接口时，键鼠可能出现输入卡顿或延迟，这是 USB 3.0 高速传输可能干扰 2.4GHz 无线信号的常见物理现象，我们建议您在遇到该现象时使用 USB 延长线将无线接收器引出，远离 USB 3.0 设备，以提升无线连接稳定性。
