...
- 支持4K编、解码  
- USB3.0 x1，USB2.0 x2，26Pin标准GPIO插座  
- 支持双M.2 2280 SSD  
- 双1000M RJ45网口  
- Type-C接口供电
...
| 显示 | 10.95寸LCD屏，支持1200*1920分辨率<br>4lane MIPI DSI FPC接口，最高支持1080P@60Hz |
| 内存 | LPDDR4X，2400MT/s速率，可选配8GB/16GB容量 |
| 本地存储 | eMMC 5.1，可选配32GB/64GB容量 |
| 扩展存储 | 2*M.2 2280 M-Key连接器，可装配 NVMe SSD<br>TF卡接口，支持UHS-II模式存储卡 |
| 无线通讯 | 支持Wi-Fi6 & BT5.2 |
| 有线网络 | 支持2路以太网，RJ45接口，1000M/100M自适应 |
| 音频接口 | 3.5mm音频耳麦接口 |
| USB接口 | 1路USB3.0和1路USB2.0 Type-A host接口<br>1路USB2.0 Type-C OTG接口，支持12V 3A供电 |
| 调试接口 | 26Pin标准GPIO接口，附带3个侧边按键，用于硬件复位、开关机和烧录升级 |
| MIPI接口 | 1路 4lane MIPI DSI<br>2路 4lane MIPI CSI，支持“4+4”或“4+2+2”组合链路 |
| 外观形态 | 单板计算机，可选装透明亚克力外壳，尺寸为129.45*80mm |
