...
- 1.8-inch compact board, credit card-sized
- UEFI boot with customizable startup options
- GRUB loader for multi-OS support
- Standard miniPCIe & M.2 for easy expansion
- China-developed, stable supply assurance
- Fully open-source: board-level, structural, software & guides
- Reliable design with ESD & EMC protection
...
| Storage Expansion | M.2 M-Key connector, 2230 size NVMe SSD, up to 1TB per slot<br>MicroSD slot, supports UHS-II |
